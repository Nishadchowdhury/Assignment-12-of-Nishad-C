...
const CreateUser = () => {
  ...
  const [updateProfile, updating, errorUpdate] =
              ...
              <form className="" onSubmit={handleSubmit(onSubmit)}>
                <div className="form-control">
                  ...
                  <div className="mt-1  ml-1">
                    {errors.name?.type === "required" && (
                      <span className="label-text text-xs-alt text-red-500">
                        {errors.name.message}
                      </span>
                    )}
                ...
                <div className="">
                  <div className="form-control">
                    ...
                    <input
                      className="pt-[8.5px] cursor-pointer input input-bordered 
                ...
                <div className="">
                  {" "}
                  <input
                    className="btn w-full btn-primary mx-auto block mt-7  input-bordered"
                    type="submit"
                    value={"Submit"}
                  />
                </div>
