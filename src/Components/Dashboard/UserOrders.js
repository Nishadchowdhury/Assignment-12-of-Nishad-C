...
const UserOrders = () => {
  ...
  const [dataForPaymentModal, setDataForPaymentModal] =
    useState(null);
    ...
    <div>
      {!userOrders.length ? (
        <div className="flex justify-center items-center w-auto">
          {" "}
          <span className="text-red-500 text-4xl lg:text-6xl mt-72">
            No Order Yet .
          </span>{" "}
        </div>
      ) : (
                ...
                (
                  ...
                  >
                    ...
                    <td>
                      <div>
                        {isPaid ? (
                          <button className="btn btn-disabled btn-xs text-green-500 ">
                            Paid{" "}
                          </button>
                        ) : (
