...
const AddReview = () => {
    ...
    return (
        <div className='flex justify-start flex-col  items-center h-[90vh]' >

            <form onSubmit={handleSubmit} className='flex justify-center flex-col items-center' >

                <div className='flex  gap-10 justify-center mt-9 w-[600px] p-3 rounded-lg  '  >
                    <div className='w-3/4 flex flex-col justify-center gap-9 border-[1px] border-slate-500 p-4 rounded-xl ' >
